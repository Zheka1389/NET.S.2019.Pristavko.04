...
namespace NET.S._2019.Pristavko._04.Tests
{
    ...
    class GcdBinaryTest
    {
        ...
        {
            return Algorithms.GcdBinary(arrayNumbers);
        }

        [TestCase(0)]
        [TestCase()]
        public void GcdBinary_Exception(params int[] arrayNumbers) =>
            Assert.Throws<ArgumentOutOfRangeException>(() => Algorithms.GcdBinary(arrayNumbers));
    }
}
